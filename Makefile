...
PROJECT_REPO ?= github.com/labrenbe/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 0.8.3
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-vra
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-vra_0.8.3
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/vras/01-delete.yaml.tmpl.
